...
export const Navbar: React.FC<NavbarProps> = ({ 
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-lg border-b border-slate-200 dark:border-slate-800 shadow-sm transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20">
          ...
          >
            ...
            <div className="border-l-2 border-slate-200 dark:border-slate-700 pl-4 hidden sm:block">
            ...
            {navLinks.map((link) => {
              ...
              return (
                <button
                  ...
                  className={`px-3 py-2 rounded-xl text-sm font-bold transition-all flex flex-col items-center ${
                    isActive
                ...
                >
                  ...
                  <span className="text-[9px] opacity-70 font-medium uppercase tracking-tighter">{link.labelEn}</span>
                </button>
              );
            })}
